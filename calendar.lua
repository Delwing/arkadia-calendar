...
function wyswietl_warianty_ishtar(wariant_miesiac)

if wariant_miesiac == 1 then
echo([[
+-------+-------------+-------------+-------------+-------------+-------------+
| DZIEN | SAOVINE (1) | SAOVINE (2) | SAOVINE (3) | SAOVINE (4) | SAOVINE (5) |
+-------+-------------+-------------+-------------+-------------+-------------+
|     1 | O           | -           | +           | -           | +           |
|     2 | O           | -           | +           | -           | +           |
|     3 | -           | -           | +           | -           | +           |
...
if wariant_miesiac == 2 then
echo([[
+-------+----------+----------+----------+----------+----------+
| DZIEN | YULE (1) | YULE (2) | YULE (3) | YULE (4) | YULE (5) |
+-------+----------+----------+----------+----------+----------+
|     1 | +        | -        | +        | O        | -        |
|     2 | +        | -        | +        | O        | -        |
|     3 | +        | -        | +        | -        | -        |
...
if wariant_miesiac == 3 then
echo([[
+-------+-------------+-------------+-------------+-------------+-------------+
| DZIEN | IMBAELK (1) | IMBAELK (2) | IMBAELK (3) | IMBAELK (4) | IMBAELK (5) |
+-------+-------------+-------------+-------------+-------------+-------------+
|     1 | +           | O           | -           | +           | -           |
|     2 | +           | O           | -           | +           | -           |
|     3 | +           | -           | -           | +           | -           |
...
if wariant_miesiac == 4 then
echo([[
+-------+-----------+-----------+-----------+-----------+-----------+
| DZIEN | BIRKE (1) | BIRKE (2) | BIRKE (3) | BIRKE (4) | BIRKE (5) |
+-------+-----------+-----------+-----------+-----------+-----------+
|     1 | -         | +         | -         | +         | O         |
|     2 | -         | +         | -         | +         | O         |
|     3 | -         | +         | -         | +         | -         |
...
if wariant_miesiac == 5 then
echo([[
+-------+------------+------------+------------+------------+------------+
| DZIEN | BLATHE (1) | BLATHE (2) | BLATHE (3) | BLATHE (4) | BLATHE (5) |
+-------+------------+------------+------------+------------+------------+
|     1 | -          | +          | O          | -          | +          |
|     2 | -          | +          | O          | -          | +          |
|     3 | -          | +          | -          | -          | +          |
...
if wariant_miesiac == 6 then
echo([[
+-------+------------+------------+------------+------------+------------+
| DZIEN | FEAINN (1) | FEAINN (2) | FEAINN (3) | FEAINN (4) | FEAINN (5) |
+-------+------------+------------+------------+------------+------------+
|     1 | O          | -          | +          | -          | +          |
|     2 | O          | -          | +          | -          | +          |
|     3 | -          | -          | +          | -          | +          |
...
if wariant_miesiac == 7 then
echo([[
+-------+------------+------------+------------+------------+------------+
| DZIEN | LAMMAS (1) | LAMMAS (2) | LAMMAS (3) | LAMMAS (4) | LAMMAS (5) |
+-------+------------+------------+------------+------------+------------+
|     1 | +          | -          | +          | O          | -          |
|     2 | +          | -          | +          | O          | -          |
|     3 | +          | -          | +          | -          | -          |
...
if wariant_miesiac == 8 then
echo([[
+-------+-----------+-----------+-----------+-----------+-----------+
| DZIEN | VELEN (1) | VELEN (2) | VELEN (3) | VELEN (4) | VELEN (5) |
+-------+-----------+-----------+-----------+-----------+-----------+
|     1 | +         | O         | -         | +         | -         |
|     2 | +         | O         | -         | +         | -         |
|     3 | +         | -         | -         | +         | -         |
...
miesiac = 3
for i=1,#kalendarz_imp_miesiac_txt,1 do
...
for i=1,#kalendarz_godzina,1 do
...
for i=#kalendarz_imp_dni_liczebniki,1,-1 do
...
for i=1,#kalendarz_imp_swieta_nazwydni,1 do
...
for i=1,#kalendarz_imp_now,1 do
...
for i=1,#kalendarz_imp_pelnia,1 do
...
for i=1,#kalendarz_imp_swieta,1 do
...
if kal_wariant == 0 then kalendarz_ish_pelnia = {1, 26, 51, 76, 101, 126, 151, 176, 201, 226, 251, 276, 301, 326, 351} end
if kal_wariant == nil then kalendarz_ish_pelnia = {1, 31, 61, 91, 121, 151, 181, 211, 241, 271, 301, 331} end
if kal_wariant == 1 then kalendarz_ish_pelnia = {1, 26, 51, 76, 101, 126, 151, 176, 201, 226, 251, 276, 301, 326, 351} end
if kal_wariant == 2 then kalendarz_ish_pelnia = {16, 41, 66, 91, 116, 141, 166, 191, 216, 241, 266, 291, 316, 341} end
if kal_wariant == 3 then kalendarz_ish_pelnia = {6, 31, 56, 81, 106, 131, 156, 181, 206, 231, 256, 281, 306, 331, 356} end
if kal_wariant == 4 then kalendarz_ish_pelnia = {21, 46, 71, 96, 121, 146, 171, 196, 221, 246, 271, 296, 321, 346} end
if kal_wariant == 5 then kalendarz_ish_pelnia = {11, 36, 61, 86, 111, 136, 161, 186, 211, 236, 261, 286, 311, 336} end
if kal_wariant == 6 then kalendarz_ish_pelnia = {1, 31, 61, 91, 121, 151, 181, 211, 241, 271, 301, 331} end

for i=1,#kalendarz_ish_miesiac_txt,1 do
...
if kal_wariant == 0 then
  wyswietl_warianty_ishtar(miesiac)
  kal_wariant = 6
  return
end
...
for i=#kalendarz_ish_dni_liczebniki,1,-1 do
...
for i=1,#kalendarz_ish_swieta_nazwy,1 do
  if string.find(kalendarz_astro, kalendarz_ish_swieta_nazwy[i]) then
...
for i=1,#kalendarz_ish_pelnia,1 do
...
for i=1,#kalendarz_ish_swieta,1 do
...
for i=1,#kalendarz_ish_festyn,1 do
...
if kal_wariant == 6 then
  echo("Obliczenia oparte o wariant \"co 30 dni\"\n")
else
  echo("Obliczenia oparte o wariant  : " .. kal_wariant .. "\n")
end
