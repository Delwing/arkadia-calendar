...
kalendarz_imp_miesiac_txt = {
    "Nachhexen", "Jahrdrung", "Pflugzeit", "Sigmarszeit", "Sommerzeit",
    "Vorgeheim", "Nachgeheim", "Erntezeit", "Brauzeit", "Kaltezeit",
    "Ulrichszeit", "Vorhexen"
}

kalendarz_ish_miesiac_txt = {
    "Saovine", "Yule", "Imbaelk", "Birke", "Blathe", "Feainn", "Lammas", "Velen"
}

kalendarz_imp_dlugosc_miesiaca = {
    32, 33, 33, 33, 33, 33, 32, 33, 33, 33, 33, 33
}

kalendarz_imp_delta_dni = {
    0, 33, 67, 100, 133, 167, 201, 233, 267, 300, 333, 367
}
...
kalendarz_imp_zachod = {
    17, 18, 18, 19, 20, 21, 21, 22, 21, 20, 20, 19, 18, 17, 17, 16
}

kalendarz_imp_pelnia = {
    26, 51, 76, 102, 126, 151, 176, 227, 251, 276, 326, 351, 376
}

kalendarz_ish_pelnia = {
    1, 26, 51, 76, 101, 126, 151, 176, 201, 226, 251, 276, 301, 326, 351
}

kalendarz_imp_swieta = {1, 67, 167, 201, 267, 367}

kalendarz_imp_swieta_nazwy = {
    "Hexentag (Nowy Rok, Noc Czarownic - Morr)",
    "Mitterfruhl (Wiosenna Rownonoc, Rozkwitanie - Taal, Ulryk, Mannan)",
    "Sonnenstill (Letnie Przesilenie, Dzien Slonca - Taal, Rhya)",
    "Geheimnisnacht (Noc Tajemnicy - Morr)",
    "Mitterherbst (Jesienna Rownonoc, Przekwitanie - Ulryk, Taal, Rhya)",
    "Mondstill (Zimowe Przesilenie, Uspienie - Ulryk, Taal, Rhya)"
}

kalendarz_imp_swieta_nazwydni = {
    "dzien Hexentag", "dzien Mitterfruhl", "dzien Sonnenstill",
    "dzien Geheimnisnacht", "dzien Mitterherbst", "dzien Mondstill"
}

kalendarz_ish_swieta = {1, 46, 91, 136, 181, 226, 271, 316}

kalendarz_ish_swieta_nazwy = {
    "Solstycjum Zimowe", "Dzien Kielkowania", "Ekwinokcjum Wiosenne",
    "Dzien Rozkwitania", "Solstycjum Letnie", "Dzien Dojrzewania",
    "Ekwinokcjum Jesienne", "Dzien Zamierania"
}

kalendarz_imp_dni_liczebniki = {
    "pierwszy dzien", "drugi dzien", "trzeci dzien", "czwarty dzien",
    "piaty dzien", "szosty dzien", "siodmy dzien", "osmy dzien",
    "dziewiaty dzien", "dziesiaty dzien", "jedenasty dzien", "dwunasty dzien",
    "trzynasty dzien", "czternasty dzien", "pietnasty dzien", "szesnasty dzien",
    "siedemnasty dzien", "osiemnasty dzien", "dziewietnasty dzien",
    "dwudziesty dzien", "dwudziesty pierwszy dzien", "dwudziesty drugi dzien",
    "dwudziesty trzeci dzien", "dwudziesty czwarty dzien",
    "dwudziesty piaty dzien", "dwudziesty szosty dzien",
    "dwudziesty siodmy dzien", "dwudziesty osmy dzien",
    "dwudziesty dziewiaty dzien", "trzydziesty dzien",
    "trzydziesty pierwszy dzien", "trzydziesty drugi dzien",
...
kalendarz_ish_dni_liczebniki = {
    ...
    "dwudziesty dziewiaty dzien", "trzydziesty dzien",
    "trzydziesty pierwszy dzien", "trzydziesty drugi dzien",
    "trzydziesty trzeci dzien", "trzydziesty czwarty dzien",
    "trzydziesty piaty dzien", "trzydziesty szosty dzien",
    "trzydziesty siodmy dzien", "trzydziesty osmy dzien",
    "trzydziesty dziewiaty dzien", "czterdziesty dzien",
    "czterdziesty pierwszy dzien", "czterdziesty drugi dzien",
    "czterdziesty trzeci dzien", "czterdziesty czwarty dzien",
    "czterdziesty piaty dzien"
}

kalendarz_godzina = {
    "pierwsza", "druga", "trzecia", "czwarta", "piata", "szosta", "siodma",
    "osma", "dziewiata", "dziesiata", "jedenasta", "dwunasta"
}

kalendarz_am = {"nad ranem", "przed poludniem", "rano", "w poludnie"}

kalendarz_pm = {"po poludniu", "wieczorem", "przed polnoca", "w nocy"}
...
function predykcje_astro_imp()
    ...
    if now >= dzien then
        ...
        now_delta = (400 + kalendarz_imp_now[1] - dzien) * 2880 - delta +
                        (zachod * 120)
    end
    ...
    echo("Tego dnia zachod slonca o godzinie " .. zachod ..
             " czasu arkadyjskiego\n\n")
